...
void setup() {
  ...
  Braccio.begin();
  Braccio.ServoMovement(20, baseAngle, shoulderAngle, elbowAngle, 90, 180, gripperAngle);
}
...
void loop() {
  ...
  Braccio.ServoMovement(10, baseAngle, shoulderAngle, elbowAngle, 90, 180, gripperAngle);
}
